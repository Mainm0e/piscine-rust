...
impl Iterator for ThrowObject {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        let new_velocity = Object {
            x: self.actual_velocity.x,
            y: self.actual_velocity.y - gravity,
        };
        let new_position = Object {
            x: self.actual_position.x + self.actual_velocity.x,
            y: self.actual_position.y + self.actual_velocity.y,
        };
